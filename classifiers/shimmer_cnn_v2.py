...
DATA_PATH = 'C:\\Users\\semih\\OneDrive\\Uni\\Project\\Code\\data\\shimmer_data.json'
# DATA_PATH = 'C:\\Users\\semih\\OneDrive\\Uni\\Project\\Code\\NEW\\test_shimmer_data.json'
...
def build_model(input_shape):
    ...
    model.add(keras.layers.Conv2D(
        32, (1, 1), activation='relu', input_shape=input_shape))
    # max pooling layer
